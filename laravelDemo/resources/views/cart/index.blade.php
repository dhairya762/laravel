                            ...
                            @foreach ($cartItem as $item)
                                <tr>
                                    ...
                                    @foreach ($products as $product)
                                        ...
                                        @endif
                                    @endforeach
                                    <td><input type="number" name="quantity[{{ $item->product_id }}]" id="quantity"
                ...
                <div class="col-md-5 float-left">
                    <form action="{{ url('cart/billing_address') }}" method="post" id="billing_form">
                        ...
                        <div class="form-check">
                            <input name="billing[save_to_address]" type="checkbox" class="form-check-input"
                                id="exampleCheck1">
                        ...
                        <div class="form-check">
                            @foreach ($payment as $item)
                                <input class="form-check-input" type="radio" name="payment_method"
                                    value="{{ $item->id }}" id="flexRadioDefault2" onchange="mage.setForm('payment');"
                        ...
                        <div class="form-check">
                            @foreach ($shipping as $item)
                                <input class="form-check-input" type="radio" name="shipping_method"
                                    value="{{ $item->id }}" id="flexRadioDefault2" onchange="mage.setForm('shipping');"
